...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="{{route('referents.update', $referents->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="col-lg-12">
                        <!--Card-->
                                    ...
                                    <div class="col-12 col-md-6 mb-3 d-inline-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Име на референтот"
                                                   ...
                                                   id="name" name="name" value="{{$referents->name}}">
                                            @error('name')
                                    ...
                                    <div class="col-md-12 col-md-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                id="description" name="description">{{$referents->description}}</textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
