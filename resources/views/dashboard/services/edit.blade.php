                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3 d-inline-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- Input -->
                                            <input type="text" placeholder="Име на услугата"
                                                   class="form-control @error('name') is-invalid @enderror"
                                                   id="name" name="name" value="{{$services->name}}">
                                            @error('name')
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-md-6 mb-3">
                                        <div class="form-group">
                                            <!-- Label -->
                                            <label class="form-label" for="description">Опис на услугата</label>
                                            <!-- Input -->
                                            <textarea
                                                class="form-control quill-editor @error('description') is-invalid @enderror"
                                                id="description" name="description">{{$services->description}}</textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
                                ...
                                <div class="text-end">
                                    ...
                                    <a href="{{route('services.index')}}" class="btn btn-secondary"
                                       data-tippy-content="Назад кон услиги">
                                                <span class="material-symbols-rounded align-middle me-2">
                                                    arrow_back_ios
                                                    </span> Назад</a>
                                </div>
