                            ...
                            <div class="col-2">
                                <a href="{{route('services.create')}}"
                                   ...
                                   style="color: white; width: 200px">
                                    ...
                                    <span class="sidebar-text">Креирај услуга</span>
                                </a>
                            </div>
                        </div>
                                    ...
                                    @foreach($services as $service)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <img src="/assets/img/services/medium/{{ $service->image }}"
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-0">{{strip_tags($service->description)}}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="">
                                                <div class="d-flex justify-content-end align-items-center">
                                                    <a href="{{route('services.show', $service->id)}}"
                                                       data-tippy-content="Прикажи услуга">
                                                                <span
                                                    ...
                                                    <a href="{{route('services.edit', $service->id)}}"
                                                       data-tippy-content="Измени услуга">
                                                                <span
                                                    ...
                                                    <form style="padding-top: 18px" method="post"
                                                        ...
                                                        <button
                                                            ...
                                                            type="submit" data-tippy-content="Избриши услуга">
                                                                    <span
