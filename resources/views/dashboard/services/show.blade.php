                ...
                <div class="table-responsive">
                    <div class="card-body">
                        ...
                        <div class="  table-nowrap mb-3 mb-lg-5">
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <img src="/assets/img/referents/medium/{{ $services->image }}"
                                            ...
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        ...
                                                        <small class="text-muted">{{$services->email}}</small>
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="d-flex align-items-center">
                                                    <div class="flex-grow-1">
                                                        <h6 class="mb-0">{{strip_tags($services->description)}}</h6>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                            ...
                            <div class="text-end">
                                <a href="{{route('services.index')}}" class="btn btn-secondary mb-2 me-2"
