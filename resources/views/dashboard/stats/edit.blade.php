...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <form method="post" action="{{route('stats.update', $stats->id)}}" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="col-lg-12">
                        <!--Card-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-12 col-md-6 mb-3 d-inline-block">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <!-- Input -->
                                            <input type="text" placeholder="Име на статичка страна"
                                                   class="form-control @error('name') is-invalid @enderror"
                                                   id="name" name="name" value="{{$stats->name}}">
                                            @error('name')
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-md-6 mb-3">
                                        <div class="form-group">
                                            <!-- Label -->
                                            <label class="form-label" for="description">Опис на статичка страна</label>
                                            <!-- Input -->
                                            <textarea
                                                class="form-control quill-editor @error('description') is-invalid @enderror"
                                                id="description" name="description">{{$stats->description}}</textarea>
                                            @error('description')
                                            <span class="invalid-feedback" role="alert">
                                                        <strong>{{ $message }}</strong>
                                                    </span>
