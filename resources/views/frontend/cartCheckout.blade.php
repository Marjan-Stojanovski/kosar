                ...
                <div class="main col-md-12">
                    ...
                    <table class="table cart">
                        ...
                        @foreach($userLists as $userList)
                                ...
                                ?>
                        <tr>
                            <td class="product"><a href="shop-product.html">{{$userList->name}}</a> <small>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quas inventore modi.</small></td>
                            <td class="price">$ {{$userList->price}}</td>
                            <td class="quantity">
                                <div class="form-group">
                                    <input type="text" class="form-control" value="{{$userList->quantity}}" disabled>
                                </div>
                            </td>
