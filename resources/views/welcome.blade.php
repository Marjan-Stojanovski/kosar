                            ...
                            <div class="navbar-header">
                                ...
                                <div class="header-left clearfix ">
                                    ...
                                    <div id="logo-mobile" class="logo">
                                        <a href="{{route('frontend.index')}}"><img id="logo-img-mobile" src="/assets/img/logo.jpg" alt="The Project" class="img-rounded" style="width: 50px">Kosar Beverages!</a>
                                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="footer-content">
                                ...
                                <nav class="mb-20">
                                    <ul class="nav nav-pills nav-stacked list-style-icons">
                                        ...
                                        <li><a href=""><i class="fa-icon-shopping-cart"></i>Trgovina</a></li>
                                        <li><a href=""><i class="icon-services"></i> Cart</a></li>
                        ...
                        <div class="col-md-3">
                            <div class="footer-content">
                                ...
                                <ul class="list-icons">
                                    <li><i class="fa fa-map-marker pr-10 text-default"></i> Stare Črnuče 3, 1231 Ljubljana</li>
                                    <li><i class="fa fa-phone pr-10 text-default"></i> +386 031 308 780</li>
                                    <li><a href="mailto:info@theproject.com"><i class="fa fa-envelope-o pr-10"></i>info@kosar.si</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-3">
