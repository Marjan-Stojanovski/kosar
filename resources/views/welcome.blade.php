...
>>>>>>> parent of bba3639... List product by categories
<head>
    <meta charset="utf-8">
                            ...
                            <ul class="social-links circle small clearfix hidden-xs">
                                <li class="logo">
                                    <div id="logo-mobile" class="logo">
                                        <img id="logo-img-mobile" src="/assets/img/logo.jpg" alt="Kosar" style="width: 75px">
                                    </div>
                                </li>
                                <li></li>
                                <li><h4>KOSAR BEVERAGES</h4></li>
                            </ul>
                        </div>
                    ...
                    <div class="col-xs-10 col-sm-7">
                        ...
                        <div id="header-top-second" class="clearfix text-right">
                            <div class="header-dropdown-buttons">
                                <a href="index-shop.html" class="btn btn-sm hidden-xs radius-50 btn-default">Store <i
                                        class="fa fa-shopping-cart pl-5"></i></a>
                                <a href="index-shop.html" class="btn btn-lg visible-xs radius-50 btn-block btn-default">Store
                                    <i class="fa fa-shopping-cart pl-5"></i></a>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-3 ">
                        ...
                        <div class="header-left clearfix">
                            ...
                            <!-- logo -->
                            <div id="logo" class="logo" style="width: 100px">
                                <a href="{{route('frontend.index')}}"><img id="logo_img" src="/assets/img/logo.jpg" alt="The Project"></a>
                            </div>

                            <!-- name-and-slogan -->
                            <div class="site-slogan">
                                <strong>Kosar</strong> Beverages
                            </div>
                                                ...
                                                <li class="dropdown active mega-menu">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <h4 class="title"><i class="fa fa-laptop pr-10"></i>
                                                                        Demos</h4>
                                                                    <div class="row">
                                        ...
                                        <div class="collapse navbar-collapse" id="navbar-collapse-1">
                                            ...
                                            <ul class="nav navbar-nav ">
                                                ...
                                                <li class="dropdown  mega-menu">
                                                    <a href="{{route('frontend.index')}} class="dropdown-toggle" data-toggle="dropdown">Domov</a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            {!! $categoriesList !!}
                                                        </li>
...
<<<<<<< HEAD
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li class="dropdown ">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="features-headers-default.html">Default</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown ">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li class="dropdown-header default-bg">SLIDER REVOLUTION
                                                                    5 - v1.2
                                                                </li>
                                                        ...
                                                        <li class="dropdown ">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a href="features-icons-fontawesome.html">Font
                                                                        Awesome</a></li>
                                                                <li><a href="features-icons-fontello.html">Fontello</a>
                                                                </li>
                                                                <li>
                                                ...
                                                <li class="dropdown  mega-menu narrow">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <h4 class="title"><i class="fa fa-magic pr-10"></i>
                                                                        Components</h4>
                                                                    <div class="row">
                                                                        <div class="col-sm-6">
                                                                            <div class="divider"></div>
...
<<<<<<< HEAD
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li class="dropdown ">
                                                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Portfolio
                                                                Grid 1</a>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="portfolio-grid-1-2-col.html">2 Column</a>
                                                                </li>
                                                                <li><a href="portfolio-grid-1-3-col.html">3 Column</a>
                                                                </li>
                                                                <li><a href="portfolio-grid-1-4-col.html">4 Column</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown ">
                                                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Portfolio
                                                                Grid 2</a>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="portfolio-grid-2-2-col.html">2 Column</a>
                                                                </li>
                                                                <li><a href="portfolio-grid-2-3-col.html">3 Column</a>
                                                                </li>
                                                                <li><a href="portfolio-grid-2-4-col.html">4 Column</a>
                                                                </li>
                                                        ...
                                                        <li class="dropdown ">
                                                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">Portfolio
                                                                Grid 3 - Dark</a>
                                                            <ul class="dropdown-menu">
                                                                <li><a href="portfolio-grid-3-2-col.html">2 Column</a>
                                                                </li>
                                                                <li><a href="portfolio-grid-3-3-col.html">3 Column</a>
                                                                </li>
                                                                <li><a href="portfolio-grid-3-4-col.html">4 Column</a>
                                                                </li>
                                                ...
                                                <li class="dropdown ">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="shop-listing-3col.html">Grid - 3 Columns</a></li>
                                                        <li><a href="shop-listing-2col.html">Grid - 2 Columns</a></li>
                                                        <li><a href="shop-listing-sidebar.html">Grid - With Sidebar</a>
                                                        </li>
                                                        <li><a href="shop-listing-list.html">List</a></li>
                                                        <li><a href="shop-product.html">Product Page</a></li>
                                                        ...
                                                        <li><a href="shop-cart.html">Shopping Cart</a></li>
                                                        <li><a href="shop-checkout.html">Checkout Page - Step 1</a></li>
                                                        <li><a href="shop-checkout-payment.html">Checkout Page - Step
                                                                2</a></li>
                                                ...
                                                <li class="dropdown ">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a href="index-blog-2.html">Blog Home 2 <span class="badge">NEW</span></a>
                                                        </li>
                                                        <li class="dropdown ">
                                            ...
                                            <div id="header-top-second" class="clearfix text-right">
                                                <div class="header-dropdown-buttons">
                                                    <a href="index-shop.html"
                                                       class="btn btn-sm hidden-xs radius-50 btn-default">Store <i
                                                            class="fa fa-shopping-cart pl-5"></i></a>
                                                    <a href="index-shop.html"
                                                       class="btn btn-lg visible-xs radius-50 btn-block btn-default">Store
                                                        <i class="fa fa-shopping-cart pl-5"></i></a>
                                                </div>
                                            </div>
                                        </div>
